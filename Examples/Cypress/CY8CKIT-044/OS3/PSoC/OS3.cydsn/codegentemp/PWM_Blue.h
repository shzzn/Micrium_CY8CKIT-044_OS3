...
#define PWM_Blue_QUAD_AUTO_START                (0lu)
...
#define PWM_Blue_PWM_STOP_EVENT                 (0lu)
#define PWM_Blue_PWM_MODE                       (6lu)
...
/* PWM Mode */
#define PWM_Blue_PWM_PERIOD_VALUE               (65535lu)
#define PWM_Blue_PWM_PERIOD_BUF_VALUE           (65535lu)
#define PWM_Blue_PWM_PERIOD_SWAP                (0lu)
#define PWM_Blue_PWM_COMPARE_VALUE              (32767lu)
